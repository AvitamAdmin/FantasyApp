          ...
          <View style={{width:wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.3),color:"#000"}}>What happens when one or more of my
                    selected players do not play in the match?</Text>
                    <Text style={{color:"#000"}}>If the Player you selected didn’t play in a match, that played will not be awarded any points.</Text>
                    
                 </View>

                 <View style={{flexDirection:"row",gap:1}}>
                 <Text style={{color:"#000"}}>Make sure you select announced player.</Text>
                 <Pressable>
