          ...
          <View style={{width:wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.5),color:"#000"}}>Can I Delete a team?</Text>
                    <Text style={{color:"#000"}}>You cannot delete your team once created, else you can edit your team or create a new team and switch it earlier one.</Text>
