...
<View style={{width: wp("100%"),flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15,paddingBottom:20}}>
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize:hp(2.3),color:"#000"}}>Playing on Impact11</Text>
                <Text style={{color:"#6F6F6F"}}>/ Managing Teams</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>How do I edit my teams?</Text>
                    <Text  style={{color:"#000"}}>You can edit your team before the match starts.</Text>
                    <Text  style={{color:"#000"}}>Follow these steps to edit your team:</Text>
                    <Text  style={{color:"#000"}}>Step 1: Go to the Home screen and click on the match for which you wish to edit your team</Text>
                    <Text  style={{color:"#000"}}>Step 2: Click on "My Teams" at the bottom-Right corner</Text>
                    <Text style={{color:"#000"}}>Step 3: Select the team that you wish to edit</Text>
                    <Text style={{color:"#000"}}>Step 4: Click on the pencil edit icon</Text>
                    <Text style={{color:"#000"}}>Step 5: Edit your team and click on "Continue"</Text>
                    <Text style={{color:"#000"}}>Step 6: Review the changes you have made and then click on "Save Team". Your changes will be saved</Text>
                 </View>
