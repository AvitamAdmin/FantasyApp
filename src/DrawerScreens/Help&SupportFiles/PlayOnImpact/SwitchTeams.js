...
<View style={{width:wp("100%"),flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width:wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>Playing on Impact11</Text>
                <Text style={{color:"#6F6F6F"}}>/ Managing Teams</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>How to switch teams in a contest?</Text>
                    <Text style={{color:"#000"}}>Step 1: Head to 'My Matches' and select the match you wish to switch teams for, from the 'Upcoming' section</Text>
                    <Text style={{color:"#000"}}>Step 2: Tap 'My Contests' and select the contest you wish to switch teams for</Text>
                    <Text style={{color:"#000"}}>Step 3: Tap on 'Leaderboard' and click on the 'Two Arrows' to the right </Text>
                    <Text style={{color:"#000"}}>Step 4: Uncheck the selected team, check the team you want to switch with, tap on 'Switch Teams', and that's it!</Text>
                    <Text style={{color:"#000"}}>PS: You can switch teams only when you have created more than one team for the contest.</Text>
                 </View>
