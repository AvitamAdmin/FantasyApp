          ...
          <View style={{width:wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.2),color:"#000"}}>Can I join a Impact11 contest with multiple
                    teams?</Text>
                    <Text style={{color:"#000"}}>The number of teams allowed per user depends on the type of contest.</Text>
                    <Text style={{color:"#000"}}>Except "Head-to-Head" and "Winner Takes All" contests, you can join every other contest with multiple teams.</Text>
                    <Text style={{color:"#000"}}>For example, you can join a Grand League with up to 20 teams. You will see the number of teams allowed per user shown next to “M” below "Total spots " on every contest card mentioned as “Upto 20” or “Upto 11”.</Text>
                    <Text style={{color:"#000"}}>For example, you can join a Grand League with up to 20 teams. You will see the number of teams allowed per user shown next to “M” below "Total spots " on every contest card mentioned as “Upto 20” or “Upto 11”.</Text>
                    <Text style={{color:"#000"}}>You can join each "Head-to-Head" and "Winner Takes All" contest with only one team.</Text>
