          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>Is the match deadline different for all user?</Text>
                    <Text  style={{color:"#000"}}>Impact11 initiates deadline at the official match start for all featured sports. The teams cannot be updated/edited post the deadline of the respective match. This deadline is put in place to ensure continued level playing field for all our users.</Text>
                 </View>
