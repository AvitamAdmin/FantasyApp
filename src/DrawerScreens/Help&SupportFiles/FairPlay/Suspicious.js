          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.3),color:"#000"}}>What are considered as Suspicious
                    activities on Impact11?</Text>
                    <Text  style={{color:"#000"}}>Using an third-party application or suspected hacking pursuit to manipulate the score or game on Impact11 may lead to the immediate termination of your account, which will forbid you to stop playing games or using any other services provided by Impact11</Text>
                 </View>
