          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.2),color:"#000"}}>Is the paid version of Online fantasy Sports
                    Gaming legal in India?</Text>
                    <Text style={{color:"#000"}}>Yes, the paid version of Online Fantasy Sports Gaming Games is legal in India as it is considered to be a legal game of skills.</Text>
                 </View>
