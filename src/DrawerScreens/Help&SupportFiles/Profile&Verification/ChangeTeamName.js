          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>Can I change my team name?</Text>
                    <Text style={{color:"#000"}}>Team names can only be changed once!</Text>
                    <Text style={{color:"#000"}}>To change your default team name,</Text>
                    <View style={{flexDirection:"column",width: wp("75%")}}>
                          <View style={{flexDirection:"row"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Head to your Profile page by clicking on your profile pic on bottom right corner.</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Tap the edit (pencil) icon next to your team name</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Select a team name of your choice and save it</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>If it is already taken, you will need to select a different one.</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>While changing your team name, please remember:</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Your team name is your identity on Impact11 and is visible to everyone</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Have a unique combination of letters and numbers, avoiding any personal information such as phone numbers, names, or email addresses.</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Avoid using inappropriate words or anything that has religious inclinations.</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text style={{color:"#000"}}>Ensure that your team name doesn't resemble Impact11 in any way.</Text>
                          </View>
                    </View>
                    <Text style={{color:"#000"}}>PS: If you’ve changed your team name previously after registration, you won't see the pencil icon next to your team name, and you won’t be able to change it again!</Text>
