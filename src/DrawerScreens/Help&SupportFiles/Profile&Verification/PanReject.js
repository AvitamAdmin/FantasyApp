...
<View style={{width: wp("100%"),flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize: hp(2.8),color:"#000"}}>Profile & Verification</Text>
                <Text style={{color:"#6F6F6F"}}>/ Verify my account</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize: hp(2.4),color:"#000"}}>Why is my PAN verification getting
                    rejected?</Text>
                    <Text style={{color:"#000"}}>As per the Google Play store policy to ensure compliance with state Gaming law,  you need to verify any one the Aadhar card, Voter ID, or Diving license.</Text>
                 </View>
                 ...
                 <View style={{flexDirection:"column",gap:15}}>
                     <Text style={{fontWeight:"bold",fontSize:17,color:"#000"}}>Was this article helpful</Text>
