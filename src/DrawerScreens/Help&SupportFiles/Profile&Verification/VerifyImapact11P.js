...
<View style={{width: wp("100%"),flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize: hp(2.4),color:"#000"}}>Profile & Verification</Text>
                <Text style={{color:"#6F6F6F"}}>/ Verify my account</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize: hp(2.3),color:"#000"}}>How to verify my Impact11 account?</Text>
                    <Text style={{color:"#000"}}>To verify your account, Go to My balance from side Navigation menu and click on “My KYC Details”
                    ...
                    <Text style={{fontWeight:"bold",fontSize: hp(2.1),color:"#000"}}>To Verify PAN card:</Text>
                    <View style={{flexDirection:"column",width:"98%"}}>
                      <Text style={{color:"#000"}}>Click on Verify next to PAN card</Text>
                      <Text style={{color:"#000"}}>Enter your name, PAN card number, date of birth and state exactly as mentioned on your PAN Card</Text>
                      <Text style={{color:"#000"}}>Upload a clear image of your PAN card and tap on 'Submit Details'</Text>
                    </View>
                    <Text style={{color:"#000"}}>And That’s it you are done</Text>
                    <Text style={{color:"#000"}}>PS: Once verified, a PAN card can’t be used on any other Impact11 account. It also can't be unlinked from your Impact11 account.</Text>
                    <Text style={{color:"#000"}}>Note:</Text>
                    <View style={{flexDirection:"column",width: wp("98%")}}>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>Full name on PAN card must match:</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>Full name on previously verified KYC document</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>Full name on bank account to be verified</Text>
                        </View>
                    </View>
                    <Text style={{color:"#000"}}>The verification will be completed in a maximum of 1 working day.</Text>
                    <Text style={{fontWeight:"bold",fontSize: hp(2.2),color:"#000"}}>To Verify Bank Account:</Text>
                    <Text style={{color:"#000"}}>Click on Verify next to Bank account</Text>
                    <Text style={{color:"#000"}}>Enter the bank account number that’s linked to your PAN card along with the IFSC code, Bank name and, Branch name, add your state and upload a clear image of your bank document.</Text>
                    <Text style={{color:"#000"}}>The verification will be completed in a maximum of 1 working day.</Text>
                    <View style={{flexDirection:"column",width: wp("78%")}}>
                        <Text style={{fontWeight:"bold",color:"#000"}}>Note:</Text>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>Accepted documents - bank passbook, cheque or bank statement which has your name, bank account number, IFSC and branch details</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>Password-protected files will be rejected</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>An email confirmation will be sent once your bank details are verified.</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>A PAN or bank account verified on a Impact11 account cannot be verified on any other Impact11 account</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>Users aren't permitted to verify NRE bank accounts</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text style={{color:"#000"}}>You can also verify payment bank accounts. However, wallets cannot be verified</Text>
                        </View>
                    </View>
                 </View>
