          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>Can I change the verified PAN card?</Text>
                    <Text style={{color:"#000"}}>Once verified, you can’t change your PAN card or use it on any other Impact11 account.</Text>
                 </View>
