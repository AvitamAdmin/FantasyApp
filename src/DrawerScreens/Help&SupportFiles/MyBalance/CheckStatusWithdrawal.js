          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>How can I check the status of my
                    withdrawal?</Text>
                    <Text style={{color:"#000"}}>Tap the <Text style={{fontWeight:"bold",color:"#000"}}>Side Navigation {">"} My Balance {">"} My Transaction.</Text></Text>
                    <Text style={{color:"#000"}}>In My Transaction go to the Withdrawal tab</Text>
                    <Text style={{color:"#000"}}>You can check the status of all these withdrawal transactions for the last 6 months. </Text>
                    <Text style={{color:"#000"}}>Details beyond the last 6 months can be downloaded via the 'Download' icon on the page.</Text>
                 </View>
