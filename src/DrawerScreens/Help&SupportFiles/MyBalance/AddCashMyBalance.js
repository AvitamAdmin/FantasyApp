          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>How do I add cash to my Impact11 account?</Text>
                    <Text style={{color:"#000"}}>You can add cash through either of the following two options:</Text>
                    <View style={{flexDirection:"column"}}>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color:"#000"}}>Click on Side Navigation menu and go the Add (or)</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color:"#000"}}>Wallet icon on the top right hand side corner</Text>
                    </View>
                    </View>
                    <View style={{flexDirection:"column"}}>
                      ...
                      <Text style={{color:"#000"}}>Enter the 'Amount to add'</Text>
                    </View>
                      <View style={{flexDirection:"row",alignItems:"center",gap:1}}>
                        <Text style={{color:"#000"}}>3.</Text>
                      <Text style={{color:"#000"}}>Select your preferred payment method.</Text>
                    </View>
                      <View style={{flexDirection:"row",gap:1}}>
                        <Text style={{color:"#000"}}>4.</Text>
                      <Text style={{color:"#000"}}>Follow the on-screen instructions to complete your payment and done!</Text>
                    </View>
                      
                    </View>
                    <Text style={{color:"#000"}}>The deposit can take a maximum of 24 hours and can be checked in the "My Recent Transactions" section.</Text>
                    
                    <View style={{flexDirection:"column", width: wp("75%")}}>
                    <Text style={{color:"#000"}}>PS:</Text>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color:"#000"}}>If the cash hasn’t been added to your account within 24 hours, the amount will be auto-refunded to the source account</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color:"#000"}}>Effective 1 October 2023, GST will be calculated at the rate of 28% on amount deposited in your Impact11 account</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color:"#000"}}>To enhance user experience, Discount Points will also be awarded to you</Text>
                    </View>
                    </View>
                 </View>
