          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>Do I get Points for Super over?</Text>
                    <Text style={{color:"#000"}}>No. Points are not awarded to the users for a super over in a match as the points scored or wickets taken by the players in a super over are not considered in their official records.</Text>
