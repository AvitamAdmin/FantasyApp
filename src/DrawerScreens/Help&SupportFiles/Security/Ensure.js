          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>Ensure responsible play</Text>
                    <View style={{flexDirection:"column",width: wp("78%")}}>
                      <View style={{flexDirection:"column"}}>
                       <View style={{flexDirection:"row"}}>
                       <Entypo name="dot-single" size={24} color="black" />
                       <Text style={{color:"#000"}}>Players must be 18 years of age to play skill games for real money.</Text>
                       </View>
                       <View style={{flexDirection:"row"}}>
                       <Entypo name="dot-single" size={24} color="black" />
                       <Text style={{color:"#000"}}>There is an option for players to set the daily and monthly playing limit, by sending us a request from their registered email address. Once set, these limits can be changed again only after 72 hours from the previous change.</Text>
                       </View>
                       <View style={{flexDirection:"row"}}>
                       <Entypo name="dot-single" size={24} color="black" />
                       <Text style={{color:"#000"}}>Players can request for their accounts to be temporarily blocked, if they want to self-exclude themselves for some time.</Text>
                       </View>
                       <View style={{flexDirection:"row"}}>
                       <Entypo name="dot-single" size={24} color="black" />
                       <Text style={{color:"#000"}}>Players can follow our ‘Guide to Responsible Play’ in order to keep a check on their play behaviour.</Text>
                       </View>
