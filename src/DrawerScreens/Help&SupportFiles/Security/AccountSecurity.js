...
<View style={{width: wp("100%"),flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize:hp(2.6),color:"#000"}}>Security</Text>
                <Text style={{color:"#6F6F6F"}}>/ Account securiy</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.4),color:"#000"}}>I think someone else is using my account,
                    what should I do?</Text>
                    <Text style={{color:"#000"}}>Immediately go to profile page and click Log out, this will make sure you’ve successfully logged out from all your devices.</Text>
                    <Text style={{color:"#000"}}>If you still think the account is being used by someone else, please contact us and we’ll help you resolve the issue.</Text>
                    <Text style={{color:"#000"}}>Note: Never share your OTP details will anyone.</Text>
                 </View>
